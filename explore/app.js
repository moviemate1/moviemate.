    ...
    if (useMobileInterestLayout) {
      trendingHeading.innerHTML = `
        <span class="trend-heading-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24"><path d="M13.1 2.4c.9 2.9.2 4.8-1.2 6.2-1.1 1.2-2.3 2.1-2.3 4 0 1.1.5 2 1.4 2.6-.1-1.1.3-2.1 1-3 .8-1.1 1.7-2.1 1.8-3.8 2 1.3 3.3 3.4 3.3 5.7 0 3.7-2.8 6.3-6.5 6.3-3.5 0-6.4-2.6-6.4-6.4 0-4.1 3.4-6.2 5.7-8.4 1-.9 1.9-2 3.2-3.2Z"></path></svg>
        </span>
