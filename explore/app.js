    ...
    if (useMobileInterestLayout) {
      trendingHeading.innerHTML = `
        <span class="trend-heading-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24"><path d="M13.7 2.2c.3 2.1-.2 3.7-1.3 4.9-.9 1-2 1.7-2.4 3.2-.4 1.4-.1 2.8.9 4-.1-.9.2-1.8.8-2.7.7-1.1 1.6-1.9 2.3-2.8 1.1-1.5 1.6-3.2 1.6-5.2 2.2 1.7 3.7 4.1 3.7 6.8 0 3.9-2.9 7.1-7.1 7.1-4.2 0-7.4-3.1-7.4-7.4 0-4.4 3.6-7.3 6-9.4.7-.6 1.4-1.2 1.9-2Z"></path></svg>
        </span>
