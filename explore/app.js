    ...
    if (useMobileInterestLayout) {
      trendingHeading.innerHTML = `
        <span class="trend-heading-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24"><path d="M12.6 2.8c.5 1.7.2 3-.6 4-.8 1-1.8 1.5-2.5 2.4-.8 1-1 2.1-.8 3 .2.9.8 1.7 1.9 2.3-.1-.4-.1-.8 0-1.2.1-.9.5-1.7 1-2.4.5-.8.9-1.5 1.1-2.5.2-.6.2-1.3.1-2 .9.7 1.6 1.6 2 2.7.4 1.2.4 2.6-.1 4.1-.7 2.1-2.4 3.5-4.8 3.9-2.7.4-5.3-.8-6.5-3.1-1.3-2.5-.7-5.7 1.6-8.3 1.6-1.8 3.7-3 6.1-3.9Z"></path></svg>
        </span>
