    ...
    if (useMobileInterestLayout) {
      trendingHeading.innerHTML = `
        <span class="trend-heading-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24"><path d="M12.8 2.8c1.7 2.1 2.6 4.2 2.6 6.5 0 1.9-.7 3.5-2 4.8.2-1.3 0-2.5-.7-3.6-.6-.9-1.5-1.6-2.1-2.5-.7.9-1.2 2-1.2 3.4 0 2.8 1.8 4.8 4.4 5.2-3.8.8-7.2-1.7-8-5.5-.6-3.2.8-6.4 3.5-8.4 0 0 1.3 3.5 4.1 5.1-.1-1.8-.4-3.5-.6-5Z"></path></svg>
        </span>
